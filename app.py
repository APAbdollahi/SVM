...
with st.sidebar:
    ...
    st.info(
        ...
        "**The Scientific Justification (Neural Tangent Kernel):**\n"
        "Modern deep learning theory (Jacot et al., 2018) proves that as neural networks become infinitely wide, they converge to linear models using a specific kernel (the Neural Tangent Kernel). "
        "Thus, this SVM is not merely a 'toy' analogy; it is the **mathematical limit** of what large language models actually are: "
        "sophisticated kernel machines performing statistical pattern matching, not biological cognition."
    )
